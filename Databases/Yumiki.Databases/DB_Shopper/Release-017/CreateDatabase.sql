...
GO
ALTER TABLE [dbo].[TB_Stock]  WITH CHECK ADD  CONSTRAINT [FK_TB_Stock_TB_Product] FOREIGN KEY([ProductID])
REFERENCES [dbo].[TB_Product] ([ID])
GO
ALTER TABLE [dbo].[TB_Stock] CHECK CONSTRAINT [FK_TB_Stock_TB_Product]
GO
