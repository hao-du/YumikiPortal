...
var AssignmentListComponent = (function () {
    function AssignmentListComponent(service) {
        this.service = service;
    }
    AssignmentListComponent.prototype.ngOnInit = function () {
        this.getUsers();
    };
    AssignmentListComponent.prototype.getUsers = function () {
        var _this = this;
        yumiki.message.displayLoadingDialog(true);
        this.service.getUsers().subscribe(function (result) {
            _this.assignments = result;
...
AssignmentListComponent = __decorate([
    core_1.Component({
        selector: 'ontime',
        templateUrl: '/Apps/OnTime/UserAssignment/List',
    }),
...
//# sourceMappingURL=assignment.component.assignments.js.map