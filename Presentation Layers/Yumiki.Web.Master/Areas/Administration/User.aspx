            ...
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li runat="server" id="liUserProcess" visible="false">
                        <asp:LinkButton runat="server" ID="btnUserProcess" Text="" CausesValidation="false" OnClick="LinkButton_Click"></asp:LinkButton></li>
                    <li runat="server" id="liUserDetails" visible="false">
                        <asp:LinkButton runat="server" ID="btnUserDetails" Text="" CausesValidation="false" OnClick="LinkButton_Click"></asp:LinkButton></li>
                    <li runat="server" id="liResetPassword" visible="false">
                        <asp:LinkButton runat="server" ID="btnResetPassword" Text="" CausesValidation="false" OnClick="LinkButton_Click"></asp:LinkButton></li>
                </ul>
                ...
                <asp:Panel runat="server" ID="pnlUserProcess" Visible="false">
                    <div class="well well-sm">
                        <div class="btn-group">
