...
namespace Yumiki.Commons.Helpers
{
    public static class EnumHelper
    {
        ...
        public static string GetDescription(object enm)
        {
            if (enm != null)
            {
                ...
                {
                    DescriptionAttribute attr = Attribute.GetCustomAttribute(memberInfo[0], typeof(DescriptionAttribute)) as DescriptionAttribute;
                    if (attr != null)
                    {
